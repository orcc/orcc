...
%struct.fifo_char_s = type { i32, i8*, i32, i32, i32, [1024 x i8] }
%struct.fifo_int_s = type { i32, i32*, i32, i32, i32, [1024 x i32] }
%struct.fifo_short_s = type { i32, i16*, i32, i32, i32, [1024 x i16] }
%struct.fifo_u_char_s = type { i32, i8*, i32, i32, i32, [1024 x i8] }
%struct.fifo_u_int_s = type { i32, i32*, i32, i32, i32, [1024 x i32] }
%struct.fifo_u_short_s = type { i32, i16*, i32, i32, i32, [1024 x i16] }
...
bb2:                                              ; preds = %bb1
  ...
  %38 = getelementptr inbounds %struct.fifo_char_s* %37, i32 0, i32 5 ; <[1024 x i8]*> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %48 = getelementptr inbounds %struct.fifo_char_s* %47, i32 0, i32 5 ; <[1024 x i8]*> [#uses=1]
...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %51 = getelementptr inbounds %struct.fifo_char_s* %50, i32 0, i32 5 ; <[1024 x i8]*> [#uses=1]
...
bb1:                                              ; preds = %entry
  %17 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %18 = getelementptr inbounds %struct.fifo_char_s* %17, i32 0, i32 5 ; <[1024 x i8]*> [#uses=1]
...
entry:
  %fifo_addr = alloca %struct.fifo_char_s*        ; <%struct.fifo_char_s**> [#uses=15]
  %n_addr = alloca i32                            ; <i32*> [#uses=5]
  ...
  store i32 %4, i32* %6, align 4
  %7 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %8 = getelementptr inbounds %struct.fifo_char_s* %7, i32 0, i32 3 ; <i32*> [#uses=1]
  %9 = load i32* %8, align 4                      ; <i32> [#uses=1]
  %10 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %11 = add nsw i32 %9, %10                       ; <i32> [#uses=1]
  %12 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
...
bb:                                               ; preds = %entry
  %16 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %17 = getelementptr inbounds %struct.fifo_char_s* %16, i32 0, i32 3 ; <i32*> [#uses=1]
  %18 = load i32* %17, align 4                    ; <i32> [#uses=1]
  %19 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %20 = add nsw i32 %18, %19                      ; <i32> [#uses=1]
  %21 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %22 = getelementptr inbounds %struct.fifo_char_s* %21, i32 0, i32 3 ; <i32*> [#uses=1]
  store i32 %20, i32* %22, align 4
  br label %bb6

bb1:                                              ; preds = %entry
  %23 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %24 = getelementptr inbounds %struct.fifo_char_s* %23, i32 0, i32 0 ; <i32*> [#uses=1]
  %25 = load i32* %24, align 4                    ; <i32> [#uses=1]
  %26 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %27 = getelementptr inbounds %struct.fifo_char_s* %26, i32 0, i32 3 ; <i32*> [#uses=1]
...
bb2:                                              ; preds = %bb1
  ...
  %36 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %37 = getelementptr inbounds %struct.fifo_char_s* %36, i32 0, i32 5 ; <[1024 x i8]*> [#uses=1]
  %38 = getelementptr inbounds [1024 x i8]* %37, i32 0, i32 0 ; <i8*> [#uses=1]
  %39 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %40 = getelementptr inbounds %struct.fifo_char_s* %39, i32 0, i32 1 ; <i8**> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %53 = load %struct.fifo_char_s** %fifo_addr, align 4 ; <%struct.fifo_char_s*> [#uses=1]
  %54 = getelementptr inbounds %struct.fifo_char_s* %53, i32 0, i32 1 ; <i8**> [#uses=1]
...
bb2:                                              ; preds = %bb1
  ...
  %39 = getelementptr inbounds %struct.fifo_short_s* %38, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %52 = getelementptr inbounds %struct.fifo_short_s* %51, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %57 = getelementptr inbounds %struct.fifo_short_s* %56, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
...
bb1:                                              ; preds = %entry
  %17 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %18 = getelementptr inbounds %struct.fifo_short_s* %17, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
...
entry:
  %fifo_addr = alloca %struct.fifo_short_s*       ; <%struct.fifo_short_s**> [#uses=15]
  %n_addr = alloca i32                            ; <i32*> [#uses=5]
  %num_beginning = alloca i32                     ; <i32*> [#uses=4]
  %num_end = alloca i32                           ; <i32*> [#uses=5]
  %"alloca point" = bitcast i32 0 to i32          ; <i32> [#uses=0]
  ...
  store i32 %4, i32* %6, align 4
  %7 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %8 = getelementptr inbounds %struct.fifo_short_s* %7, i32 0, i32 3 ; <i32*> [#uses=1]
  %9 = load i32* %8, align 4                      ; <i32> [#uses=1]
  %10 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %11 = add nsw i32 %9, %10                       ; <i32> [#uses=1]
  %12 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
...
bb:                                               ; preds = %entry
  %16 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %17 = getelementptr inbounds %struct.fifo_short_s* %16, i32 0, i32 3 ; <i32*> [#uses=1]
  %18 = load i32* %17, align 4                    ; <i32> [#uses=1]
  %19 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %20 = add nsw i32 %18, %19                      ; <i32> [#uses=1]
  %21 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %22 = getelementptr inbounds %struct.fifo_short_s* %21, i32 0, i32 3 ; <i32*> [#uses=1]
  store i32 %20, i32* %22, align 4
  br label %bb6

bb1:                                              ; preds = %entry
  %23 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %24 = getelementptr inbounds %struct.fifo_short_s* %23, i32 0, i32 0 ; <i32*> [#uses=1]
  %25 = load i32* %24, align 4                    ; <i32> [#uses=1]
  %26 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %27 = getelementptr inbounds %struct.fifo_short_s* %26, i32 0, i32 3 ; <i32*> [#uses=1]
  %28 = load i32* %27, align 4                    ; <i32> [#uses=1]
  %29 = sub i32 %25, %28                          ; <i32> [#uses=1]
  store i32 %29, i32* %num_end, align 4
  %30 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
...
bb2:                                              ; preds = %bb1
  ...
  %37 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %38 = getelementptr inbounds %struct.fifo_short_s* %37, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
  ...
  %41 = getelementptr inbounds %struct.fifo_short_s* %40, i32 0, i32 1 ; <i16**> [#uses=1]
  %42 = load i16** %41, align 4                   ; <i16*> [#uses=1]
  %43 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %44 = getelementptr inbounds %struct.fifo_short_s* %43, i32 0, i32 3 ; <i32*> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %54 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %55 = getelementptr inbounds %struct.fifo_short_s* %54, i32 0, i32 5 ; <[1024 x i16]*> [#uses=1]
  %56 = getelementptr inbounds [1024 x i16]* %55, i32 0, i32 %53 ; <i16*> [#uses=1]
  %57 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %58 = getelementptr inbounds %struct.fifo_short_s* %57, i32 0, i32 1 ; <i16**> [#uses=1]
...
bb5:                                              ; preds = %bb4, %bb3
  %62 = load %struct.fifo_short_s** %fifo_addr, align 4 ; <%struct.fifo_short_s*> [#uses=1]
  %63 = getelementptr inbounds %struct.fifo_short_s* %62, i32 0, i32 3 ; <i32*> [#uses=1]
...
bb2:                                              ; preds = %bb1
  ...
  %39 = getelementptr inbounds %struct.fifo_int_s* %38, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %52 = getelementptr inbounds %struct.fifo_int_s* %51, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %57 = getelementptr inbounds %struct.fifo_int_s* %56, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
...
bb1:                                              ; preds = %entry
  %17 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %18 = getelementptr inbounds %struct.fifo_int_s* %17, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
...
entry:
  %fifo_addr = alloca %struct.fifo_int_s*         ; <%struct.fifo_int_s**> [#uses=15]
  %n_addr = alloca i32                            ; <i32*> [#uses=5]
  %num_beginning = alloca i32                     ; <i32*> [#uses=4]
  %num_end = alloca i32                           ; <i32*> [#uses=5]
  %"alloca point" = bitcast i32 0 to i32          ; <i32> [#uses=0]
  ...
  store i32 %4, i32* %6, align 4
  %7 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %8 = getelementptr inbounds %struct.fifo_int_s* %7, i32 0, i32 3 ; <i32*> [#uses=1]
  %9 = load i32* %8, align 4                      ; <i32> [#uses=1]
  %10 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %11 = add nsw i32 %9, %10                       ; <i32> [#uses=1]
  %12 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
...
bb:                                               ; preds = %entry
  %16 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %17 = getelementptr inbounds %struct.fifo_int_s* %16, i32 0, i32 3 ; <i32*> [#uses=1]
  %18 = load i32* %17, align 4                    ; <i32> [#uses=1]
  %19 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %20 = add nsw i32 %18, %19                      ; <i32> [#uses=1]
  %21 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %22 = getelementptr inbounds %struct.fifo_int_s* %21, i32 0, i32 3 ; <i32*> [#uses=1]
  store i32 %20, i32* %22, align 4
  br label %bb6

bb1:                                              ; preds = %entry
  %23 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %24 = getelementptr inbounds %struct.fifo_int_s* %23, i32 0, i32 0 ; <i32*> [#uses=1]
  %25 = load i32* %24, align 4                    ; <i32> [#uses=1]
  %26 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %27 = getelementptr inbounds %struct.fifo_int_s* %26, i32 0, i32 3 ; <i32*> [#uses=1]
  %28 = load i32* %27, align 4                    ; <i32> [#uses=1]
  %29 = sub i32 %25, %28                          ; <i32> [#uses=1]
  store i32 %29, i32* %num_end, align 4
  %30 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
...
bb2:                                              ; preds = %bb1
  ...
  %37 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %38 = getelementptr inbounds %struct.fifo_int_s* %37, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
  %39 = getelementptr inbounds [1024 x i32]* %38, i32 0, i32 0 ; <i32*> [#uses=1]
  %40 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %41 = getelementptr inbounds %struct.fifo_int_s* %40, i32 0, i32 1 ; <i32**> [#uses=1]
  %42 = load i32** %41, align 4                   ; <i32*> [#uses=1]
  %43 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %44 = getelementptr inbounds %struct.fifo_int_s* %43, i32 0, i32 3 ; <i32*> [#uses=1]
  %45 = load i32* %44, align 4                    ; <i32> [#uses=1]
...
bb4:                                              ; preds = %bb3
  ...
  %53 = load i32* %num_end, align 4               ; <i32> [#uses=1]
  %54 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %55 = getelementptr inbounds %struct.fifo_int_s* %54, i32 0, i32 5 ; <[1024 x i32]*> [#uses=1]
  ...
  %58 = getelementptr inbounds %struct.fifo_int_s* %57, i32 0, i32 1 ; <i32**> [#uses=1]
...
bb5:                                              ; preds = %bb4, %bb3
  %62 = load %struct.fifo_int_s** %fifo_addr, align 4 ; <%struct.fifo_int_s*> [#uses=1]
  %63 = getelementptr inbounds %struct.fifo_int_s* %62, i32 0, i32 3 ; <i32*> [#uses=1]
  %64 = load i32* %num_beginning, align 4         ; <i32> [#uses=1]
  store i32 %64, i32* %63, align 4
  br label %bb6
