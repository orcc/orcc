...
@input_file = internal global i8* null              ; <i8**> [#uses=5]
...
@O = constant %struct.fifo_i8_s* null ; <%struct.fifo_i8_s**> [#uses=3]
...
bb2:                                              ; preds = %bb5
  %7 = load %struct.fifo_i8_s** @O, align 4 ; <%struct.fifo_i8_s*> [#uses=1]
  %8 = call i8* @fifo_i8_write(%struct.fifo_i8_s* %7, i32 1) nounwind ; <i8*> [#uses=1]
...
bb4:                                              ; preds = %bb3, %bb2
  ...
  %23 = load %struct.fifo_i8_s** @O, align 4 ; <%struct.fifo_i8_s*> [#uses=1]
  call void @fifo_i8_write_end(%struct.fifo_i8_s* %23, i32 1) nounwind
  br label %bb5

bb5:                                              ; preds = %bb4, %bb1
  %24 = load %struct.fifo_i8_s** @O, align 4 ; <%struct.fifo_i8_s*> [#uses=1]
  %25 = call i32 @fifo_i8_has_room(%struct.fifo_i8_s* %24, i32 1) nounwind ; <i32> [#uses=1]
