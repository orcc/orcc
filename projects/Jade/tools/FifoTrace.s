...
bb1:                                              ; preds = %bb2
  ...
  %12 = load %struct.fifo_i8_s** %fifo_addr, align 4 ; <%struct.fifo_i8_s*> [#uses=1]
  %13 = getelementptr inbounds %struct.fifo_i8_s* %12, i32 0, i32 5 ; <i32*> [#uses=1]
  %14 = load i32* %13, align 4                    ; <i32> [#uses=1]
...
bb7:                                              ; preds = %bb6, %bb3
  ...
  %46 = getelementptr inbounds %struct.fifo_i8_s* %45, i32 0, i32 6 ; <i32*> [#uses=1]
  ...
  %51 = getelementptr inbounds %struct.fifo_i8_s* %50, i32 0, i32 6 ; <i32*> [#uses=1]
  store i32 %49, i32* %51, align 4
  %52 = load %struct.fifo_i8_s** %fifo_addr, align 4 ; <%struct.fifo_i8_s*> [#uses=1]
  %53 = getelementptr inbounds %struct.fifo_i8_s* %52, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb8:                                              ; preds = %bb7
  ...
  %62 = getelementptr inbounds %struct.fifo_i8_s* %61, i32 0, i32 5 ; <i32*> [#uses=1]
  ...
  %67 = getelementptr inbounds %struct.fifo_i8_s* %66, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb10:                                             ; preds = %bb9
  ...
  %78 = getelementptr inbounds %struct.fifo_i8_s* %77, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb12:                                             ; preds = %bb11
  ...
  %99 = getelementptr inbounds %struct.fifo_i8_s* %98, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb15:                                             ; preds = %bb14, %bb13
  ...
  %114 = getelementptr inbounds %struct.fifo_i8_s* %113, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb1:                                              ; preds = %bb2
  ...
  %12 = load %struct.fifo_i16_s** %fifo_addr, align 4 ; <%struct.fifo_i16_s*> [#uses=1]
  %13 = getelementptr inbounds %struct.fifo_i16_s* %12, i32 0, i32 5 ; <i32*> [#uses=1]
  %14 = load i32* %13, align 4                    ; <i32> [#uses=1]
  %15 = load i32* %i, align 4                     ; <i32> [#uses=1]
  %16 = add nsw i32 %14, %15                      ; <i32> [#uses=1]
...
bb7:                                              ; preds = %bb6, %bb3
  ...
  %46 = getelementptr inbounds %struct.fifo_i16_s* %45, i32 0, i32 6 ; <i32*> [#uses=1]
  %47 = load i32* %46, align 4                    ; <i32> [#uses=1]
  %48 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %49 = add nsw i32 %47, %48                      ; <i32> [#uses=1]
  %50 = load %struct.fifo_i16_s** %fifo_addr, align 4 ; <%struct.fifo_i16_s*> [#uses=1]
  %51 = getelementptr inbounds %struct.fifo_i16_s* %50, i32 0, i32 6 ; <i32*> [#uses=1]
  store i32 %49, i32* %51, align 4
  %52 = load %struct.fifo_i16_s** %fifo_addr, align 4 ; <%struct.fifo_i16_s*> [#uses=1]
  %53 = getelementptr inbounds %struct.fifo_i16_s* %52, i32 0, i32 5 ; <i32*> [#uses=1]
  %54 = load i32* %53, align 4                    ; <i32> [#uses=1]
  %55 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %56 = add nsw i32 %54, %55                      ; <i32> [#uses=1]
  %57 = load %struct.fifo_i16_s** %fifo_addr, align 4 ; <%struct.fifo_i16_s*> [#uses=1]
...
bb8:                                              ; preds = %bb7
  ...
  %62 = getelementptr inbounds %struct.fifo_i16_s* %61, i32 0, i32 5 ; <i32*> [#uses=1]
  %63 = load i32* %62, align 4                    ; <i32> [#uses=1]
  %64 = load i32* %n_addr, align 4                ; <i32> [#uses=1]
  %65 = add nsw i32 %63, %64                      ; <i32> [#uses=1]
  %66 = load %struct.fifo_i16_s** %fifo_addr, align 4 ; <%struct.fifo_i16_s*> [#uses=1]
  %67 = getelementptr inbounds %struct.fifo_i16_s* %66, i32 0, i32 5 ; <i32*> [#uses=1]
  store i32 %65, i32* %67, align 4
  br label %bb16
...
bb10:                                             ; preds = %bb9
  ...
  %78 = getelementptr inbounds %struct.fifo_i16_s* %77, i32 0, i32 5 ; <i32*> [#uses=1]
  store i32 0, i32* %78, align 4
  br label %bb16
...
bb12:                                             ; preds = %bb11
  ...
  %100 = getelementptr inbounds %struct.fifo_i16_s* %99, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb15:                                             ; preds = %bb14, %bb13
  ...
  %120 = getelementptr inbounds %struct.fifo_i16_s* %119, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb1:                                              ; preds = %bb2
  ...
  %12 = load %struct.fifo_i32_s** %fifo_addr, align 4 ; <%struct.fifo_i32_s*> [#uses=1]
  %13 = getelementptr inbounds %struct.fifo_i32_s* %12, i32 0, i32 5 ; <i32*> [#uses=1]
  %14 = load i32* %13, align 4                    ; <i32> [#uses=1]
  %15 = load i32* %i, align 4                     ; <i32> [#uses=1]
  %16 = add nsw i32 %14, %15                      ; <i32> [#uses=1]
...
bb7:                                              ; preds = %bb6, %bb3
  %43 = load %struct.fifo_i32_s** %fifo_addr, align 4 ; <%struct.fifo_i32_s*> [#uses=1]
  %44 = getelementptr inbounds %struct.fifo_i32_s* %43, i32 0, i32 6 ; <i32*> [#uses=1]
  ...
  %49 = getelementptr inbounds %struct.fifo_i32_s* %48, i32 0, i32 6 ; <i32*> [#uses=1]
  store i32 %47, i32* %49, align 4
  %50 = load %struct.fifo_i32_s** %fifo_addr, align 4 ; <%struct.fifo_i32_s*> [#uses=1]
  %51 = getelementptr inbounds %struct.fifo_i32_s* %50, i32 0, i32 5 ; <i32*> [#uses=1]
  %52 = load i32* %51, align 4                    ; <i32> [#uses=1]
...
bb8:                                              ; preds = %bb7
  ...
  %60 = getelementptr inbounds %struct.fifo_i32_s* %59, i32 0, i32 5 ; <i32*> [#uses=1]
  ...
  %65 = getelementptr inbounds %struct.fifo_i32_s* %64, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb10:                                             ; preds = %bb9
  ...
  %76 = getelementptr inbounds %struct.fifo_i32_s* %75, i32 0, i32 5 ; <i32*> [#uses=1]
...
bb12:                                             ; preds = %bb11
  ...
  %98 = getelementptr inbounds %struct.fifo_i32_s* %97, i32 0, i32 5 ; <i32*> [#uses=1]
