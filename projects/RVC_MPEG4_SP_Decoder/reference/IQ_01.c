...
extern struct fifo_s *IQ_01_DC;
extern struct fifo_s *IQ_01_AC;
extern struct fifo_s *IQ_01_QP;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *IQ_01_OUT;
...
static void get_qp() {
  ...
  OUT = getWritePtr(IQ_01_OUT, 1);
  QP = getReadPtr(IQ_01_QP, 1);
  q_1 = QP[0];
  DC = getReadPtr(IQ_01_DC, 1);
  i_1 = DC[0];
  quant = q_1;
  round = q_1 & 1 ^ 1;
  count = 0;
...
static int isSchedulable_get_qp() {
  ...
  _tmp1_1 = hasTokens(IQ_01_QP, 1);
  _tmp2_1 = hasTokens(IQ_01_DC, 1);
  if (_tmp1_1 && _tmp2_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void ac() {
  ...
  OUT = getWritePtr(IQ_01_OUT, 63);
  AC = getReadPtr(IQ_01_AC, 63);
  _i0_1 = 0;
  _i0_3 = _i0_1;
  while (_i0_3 < 63) {
