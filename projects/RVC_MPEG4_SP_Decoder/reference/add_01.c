...
extern struct fifo_s *add_01_MOT;
extern struct fifo_s *add_01_TEX;
extern struct fifo_s *add_01_BTYPE;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *add_01_VID;
...
static void cmd_newVop() {
  ...
  BTYPE = getReadPtr(add_01_BTYPE, 1);
}
...
static int isSchedulable_cmd_newVop() {
  ...
  _tmp1_1 = hasTokens(add_01_BTYPE, 1);
  if (_tmp1_1) {
    BTYPE = getPeekPtr(add_01_BTYPE, 1);
    cmd_1 = BTYPE[0];
...
static void texture() {
  ...
  VID = getWritePtr(add_01_VID, 64);
  TEX = getReadPtr(add_01_TEX, 64);
  _i0_1 = 0;
  _i0_3 = _i0_1;
  while (_i0_3 < 64) {
...
static int isSchedulable_texture() {
  ...
  _tmp1_1 = hasTokens(add_01_TEX, 64);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static int isSchedulable_motion() {
  ...
  _tmp1_1 = hasTokens(add_01_MOT, 64);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static int isSchedulable_combine() {
  ...
  _tmp1_1 = hasTokens(add_01_MOT, 64);
  _tmp2_1 = hasTokens(add_01_TEX, 64);
  if (_tmp1_1 && _tmp2_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
