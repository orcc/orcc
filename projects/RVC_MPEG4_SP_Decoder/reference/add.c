...
static void texture() {
  ...
  VID = getWritePtr(add_VID, 64);
  TEX = getReadPtr(add_TEX, 64);
  _i0_1 = 0;
  _i0_3 = _i0_1;
  while (_i0_3 < 64) {
