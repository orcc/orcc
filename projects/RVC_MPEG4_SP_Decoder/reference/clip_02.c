...
extern struct fifo_s *clip_02_I;
extern struct fifo_s *clip_02_SIGNED;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *clip_02_O;
...
static void read_signed() {
  ...
  SIGNED = getReadPtr(clip_02_SIGNED, 1);
  s_1 = SIGNED[0];
  sflag = s_1;
}
...
static int isSchedulable_read_signed() {
  ...
  _tmp1_1 = hasTokens(clip_02_SIGNED, 1);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void clip() {
  ...
  O = getWritePtr(clip_02_O, 64);
  I = getReadPtr(clip_02_I, 64);
  _i0_1 = 0;
  _i0_3 = _i0_1;
  while (_i0_3 < 64) {
    _tmp0_1 = I[1 * _i0_3 + 0];
...
static int isSchedulable_clip() {
  ...
  _tmp1_1 = hasTokens(clip_02_I, 64);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
