 ...
 * <ul>
 * <li>{@link net.sf.orcc.backends.instructions.impl.InstCastImpl#getTarget <em>
 * Target</em>}</li>
 * <li>{@link net.sf.orcc.backends.instructions.impl.InstCastImpl#getSource <em>
 * Source</em>}</li>
 * </ul>
 * </p>
 * 
...
public class InstCastImpl extends InstSpecificImpl implements InstCast {
	...
	public NotificationChain basicSetSource(Use newSource,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, InstructionsPackage.INST_CAST__SOURCE,
					oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetTarget(Def newTarget,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, InstructionsPackage.INST_CAST__TARGET,
					oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSource(Use newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- InstructionsPackage.INST_CAST__SOURCE, null,
						msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					InstructionsPackage.INST_CAST__SOURCE, newSource, newSource));
	}
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- InstructionsPackage.INST_CAST__TARGET, null,
						msgs);
			if (newTarget != null)
