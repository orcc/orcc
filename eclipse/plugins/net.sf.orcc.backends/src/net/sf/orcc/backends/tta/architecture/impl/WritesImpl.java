 ...
 * <ul>
 *   <li>{@link net.sf.orcc.backends.tta.architecture.impl.WritesImpl#getStartCycle <em>Start Cycle</em>}</li>
 *   <li>{@link net.sf.orcc.backends.tta.architecture.impl.WritesImpl#getCycles <em>Cycles</em>}</li>
 *   <li>{@link net.sf.orcc.backends.tta.architecture.impl.WritesImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WritesImpl extends EObjectImpl implements Writes {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.WRITES;
	}
	...
	public void setName(int newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.WRITES__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArchitecturePackage.WRITES__CYCLES:
				return getCycles();
			case ArchitecturePackage.WRITES__NAME:
				return getName();
		}
