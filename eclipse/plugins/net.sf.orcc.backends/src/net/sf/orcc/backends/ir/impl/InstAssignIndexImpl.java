...
public class InstAssignIndexImpl extends InstSpecificImpl implements InstAssignIndex {
	...
	public EList<Expression> getIndexes() {
		if (indexes == null) {
			indexes = new EObjectContainmentEList<Expression>(Expression.class, this, IrSpecificPackage.INST_ASSIGN_INDEX__INDEXES);
		}
		return indexes;
	}
	...
	public NotificationChain basicSetTarget(Def newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IrSpecificPackage.INST_ASSIGN_INDEX__TARGET, oldTarget, newTarget);
	...
	public void setTarget(Def newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IrSpecificPackage.INST_ASSIGN_INDEX__TARGET, null, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IrSpecificPackage.INST_ASSIGN_INDEX__TARGET, null, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrSpecificPackage.INST_ASSIGN_INDEX__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain basicSetListType(Type newListType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IrSpecificPackage.INST_ASSIGN_INDEX__LIST_TYPE, oldListType, newListType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setListType(Type newListType) {
		if (newListType != listType) {
			NotificationChain msgs = null;
			if (listType != null)
				msgs = ((InternalEObject)listType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IrSpecificPackage.INST_ASSIGN_INDEX__LIST_TYPE, null, msgs);
			if (newListType != null)
				msgs = ((InternalEObject)newListType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IrSpecificPackage.INST_ASSIGN_INDEX__LIST_TYPE, null, msgs);
			msgs = basicSetListType(newListType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrSpecificPackage.INST_ASSIGN_INDEX__LIST_TYPE, newListType, newListType));
	}
