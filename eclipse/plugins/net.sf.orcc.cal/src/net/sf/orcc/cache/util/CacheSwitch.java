 ...
 * @generated
 */
public class CacheSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public T caseCacheManager(CacheManager object) {
		return null;
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CachePackage.CACHE: {
				Cache cache = (Cache)theEObject;
				T result = caseCache(cache);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CachePackage.CACHE_MANAGER: {
				CacheManager cacheManager = (CacheManager)theEObject;
				T result = caseCacheManager(cacheManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
