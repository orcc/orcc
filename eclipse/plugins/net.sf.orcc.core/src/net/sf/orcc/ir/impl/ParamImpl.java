...
public class ParamImpl extends EObjectImpl implements Param {
	...
	public NotificationChain basicSetVariable(Var newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IrPackage.PARAM__VARIABLE, oldVariable, newVariable);
	...
	public void setVariable(Var newVariable) {
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IrPackage.PARAM__VARIABLE, null, msgs);
			if (newVariable != null)
				msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IrPackage.PARAM__VARIABLE, null, msgs);
