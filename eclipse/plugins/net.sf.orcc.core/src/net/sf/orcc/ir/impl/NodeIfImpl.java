 ...
 * <li>{@link net.sf.orcc.ir.impl.NodeIfImpl#getLineNumber <em>Line Number</em>}
 * </li>
...
public class NodeIfImpl extends NodeImpl implements NodeIf {
	...
	/**
	 * The cached value of the '{@link #getElseNodes() <em>Else Nodes</em>}'
	...
	/**
	 * The cached value of the '{@link #getJoinNode() <em>Join Node</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getJoinNode()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getThenNodes() <em>Then Nodes</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getThenNodes()
	 * @generated
