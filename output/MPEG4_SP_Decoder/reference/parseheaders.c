...
static int VOL_START_CODE_LENGTH = 28;
static int VOL_START_CODE = 18;
static int VOL_ID_LENGTH = 5;
...
static int VOP_START_CODE_LENGTH = 32;
static int VO_START_CODE = 257;
static int VOP_START_CODE = 438;
...
static long long read_result_in_progress;
...
static void look_for_vo() {
  set_bits_to_read(27);
}

static int isSchedulable_look_for_vo() {
  int _tmp0_2;
...
static void vo_header_good() {
  set_bits_to_read(5);
}

static int isSchedulable_vo_header_good() {
  int _tmp1_1;
  int _tmp2_1;
  int _tmp4_1;
  int _tmp0_1;
  ...
  _tmp2_1 = read_result();
  _tmp4_1 = mask_bits(_tmp2_1, 27);
  _tmp0_1 = _tmp1_1 && _tmp4_1 == 8;
  _tmp0_2 = _tmp0_1;
  return _tmp0_2;
}

static void vo_skip_id_field() {
  set_bits_to_read(28);
}

static int isSchedulable_vo_skip_id_field() {
  int _tmp0_1;
  int _tmp0_2;
...
static void vol_startcode_good() {
  set_bits_to_read(13);
}

static int isSchedulable_vol_startcode_good() {
  int _tmp1_1;
  int _tmp2_1;
  int _tmp4_1;
  int _tmp0_1;
  ...
  _tmp1_1 = done_reading_bits();
  _tmp2_1 = read_result();
  _tmp4_1 = mask_bits(_tmp2_1, 28);
  _tmp0_1 = _tmp1_1 && _tmp4_1 == 18;
  _tmp0_2 = _tmp0_1;
  return _tmp0_2;
}
...
static void get_vop_code() {
  set_bits_to_read(32);
}

static int isSchedulable_get_vop_code() {
  int _tmp0_1;
  int _tmp0_2;
...
static void vop_code_done() {
  bit_count = 0;
}

static int isSchedulable_vop_code_done() {
  int _tmp1_1;
  int _tmp2_1;
  int _tmp0_1;
  int _tmp0_2;
  ...
  _tmp1_1 = done_reading_bits();
  _tmp2_1 = read_result();
  _tmp0_1 = _tmp1_1 && _tmp2_1 == 1;
  _tmp0_2 = _tmp0_1;
  return _tmp0_2;
}

static void vop_code_start() {
  mbx = 0;
  mby = 0;
  set_bits_to_read(2);
}

static int isSchedulable_vop_code_start() {
  int _tmp1_1;
  int _tmp2_1;
  int _tmp0_1;
  int _tmp0_2;
  ...
  _tmp1_1 = done_reading_bits();
  _tmp2_1 = read_result();
  _tmp0_1 = _tmp1_1 && _tmp2_1 == 438;
  _tmp0_2 = _tmp0_1;
  return _tmp0_2;
}

static void vo_code_start() {
}

static int isSchedulable_vo_code_start() {
  int _tmp1_1;
  int _tmp2_1;
  int _tmp0_1;
  int _tmp0_2;
  ...
  _tmp1_1 = done_reading_bits();
  _tmp2_1 = read_result();
  _tmp0_1 = _tmp1_1 && _tmp2_1 == 257;
  _tmp0_2 = _tmp0_1;
  return _tmp0_2;
}

static void vop_predict() {
  int _tmp0_1;
  int _tmp2_1;
...
static int isSchedulable_vop_predict() {
  int _tmp0_1;
  int _tmp0_2;
...
static enum states _FSM_state = s_look_for_vo;
...
static int get_vop_code_state_scheduler() {
  int res;
  
  if (isSchedulable_get_vop_code()) {
    get_vop_code();
    _FSM_state = s_vop_code;
    res = 1;
  } else {
    res = 0;
  }
...
static int look_for_vo_state_scheduler() {
  int res;
  
  if (isSchedulable_look_for_vo()) {
    look_for_vo();
    _FSM_state = s_vo_header;
    res = 1;
  } else {
    res = 0;
  }
...
static int look_for_vol_state_scheduler() {
  int res;
  
  if (isSchedulable_vol_startcode_good()) {
    vol_startcode_good();
...
static int look_for_vop_state_scheduler() {
  int res;
  
  if (isSchedulable_byte_align()) {
    byte_align();
    _FSM_state = s_get_vop_code;
    res = 1;
  } else {
    res = 0;
  }
...
static int vo_header_state_scheduler() {
  int res;
  
  if (isSchedulable_vo_header_good()) {
    vo_header_good();
    _FSM_state = s_vo_skip_id_field;
    res = 1;
  } else {
    if (isSchedulable_generic_done()) {
      generic_done();
...
static int vo_skip_id_field_state_scheduler() {
  int res;
  
  if (isSchedulable_vo_skip_id_field()) {
    vo_skip_id_field();
    _FSM_state = s_look_for_vol;
    res = 1;
  } else {
    res = 0;
  }
...
static int vop_code_state_scheduler() {
  int res;
  
  if (isSchedulable_vo_code_start()) {
    vo_code_start();
    _FSM_state = s_vo_skip_id_field;
    res = 1;
  } else {
    if (isSchedulable_vop_code_done()) {
      vop_code_done();
      _FSM_state = s_look_for_vol;
      res = 1;
    } else {
      if (isSchedulable_vop_code_start()) {
        vop_code_start();
    ...
    if (outside_FSM_scheduler()) {
      ...
      switch (_FSM_state) {
        ...
        case s_get_residual_y:
          ...
          break;
        case s_get_vop_code:
          res = get_vop_code_state_scheduler();
          break;
        case s_look_for_vo:
          res = look_for_vo_state_scheduler();
          break;
        case s_look_for_vol:
          res = look_for_vol_state_scheduler();
          break;
        case s_look_for_vop:
          res = look_for_vop_state_scheduler();
          break;
        case s_mag_x:
        ...
        case s_vld_direct:
          ...
          break;
        case s_vo_header:
          res = vo_header_state_scheduler();
          break;
        case s_vo_skip_id_field:
          res = vo_skip_id_field_state_scheduler();
          break;
        case s_vol_aspect:
