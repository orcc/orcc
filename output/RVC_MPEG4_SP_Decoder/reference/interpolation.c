...
extern struct fifo_s *interpolation_RD;
extern struct fifo_s *interpolation_halfpel;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *interpolation_MOT;
...
static void start() {
  ...
  halfpel = getReadPtr(interpolation_halfpel, 1);
  f_1 = halfpel[0];
  x = 0;
  y = 0;
  flags = f_1 >> 1;
...
static int isSchedulable_start() {
  ...
  _tmp1_1 = hasTokens(interpolation_halfpel, 1);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void row_col_0() {
  ...
  RD = getReadPtr(interpolation_RD, 1);
  d_1 = RD[0];
  _tmp0_1 = d8;
  d9 = _tmp0_1;
  _tmp1_1 = d7;
...
static int isSchedulable_row_col_0() {
  ...
  _tmp1_1 = hasTokens(interpolation_RD, 1);
  if (_tmp1_1) {
    RD = getPeekPtr(interpolation_RD, 1);
    _tmp2_1 = x;
    _tmp3_1 = y;
...
static void other() {
  ...
  MOT = getWritePtr(interpolation_MOT, 1);
  RD = getReadPtr(interpolation_RD, 1);
  d_1 = RD[0];
  _tmp0_1 = d9;
  _tmp1_1 = d8;
  ...
  if (isSchedulable_done()) {
    ...
    if (isSchedulable_row_col_0()) {
      ...
      if (isSchedulable_other()) {
        if (hasRoom(interpolation_MOT, 1)) {
          other();
          _FSM_state = s_interpolate;
          res = 1;
        } else {
