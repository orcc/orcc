...
extern struct fifo_s *address_02_MV;
extern struct fifo_s *address_02_BTYPE;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *address_02_RA;
extern struct fifo_s *address_02_WA;
extern struct fifo_s *address_02_halfpel;
...
static void advance_block() {
  ...
  _tmp2_1 = vop_luma_width;
  _tmp1_1 = _tmp2_1;
  _tmp1_2 = _tmp1_1;
  current_w = _tmp1_2;
  _tmp6_1 = vop_luma_height;
  _tmp5_1 = _tmp6_1;
  _tmp5_2 = _tmp5_1;
  current_h = _tmp5_2;
  _tmp9_2 = 2214784;
  current_size = _tmp9_2;
  _tmp14_1 = next_luma_x;
  _tmp13_1 = _tmp14_1;
  _tmp13_2 = _tmp13_1;
  current_x = _tmp13_2;
  _tmp18_1 = next_luma_y;
  _tmp17_1 = _tmp18_1;
  _tmp17_2 = _tmp17_1;
  current_y = _tmp17_2;
  _tmp22_1 = luma_read_ring_start;
  _tmp21_1 = _tmp22_1;
  _tmp21_2 = _tmp21_1;
  current_read_ring_start = _tmp21_2;
  _tmp26_1 = luma_write_ring_start;
  _tmp25_1 = _tmp26_1;
  _tmp25_2 = _tmp25_1;
  ...
  _tmp34_1 = next_comp;
  _tmp35_1 = next_comp;
  if (_tmp34_1 == 1 || _tmp35_1 == 3) {
    _tmp36_1 = next_luma_x;
    next_luma_x = _tmp36_1 + 8;
  }
  _tmp37_1 = next_comp;
  if (_tmp37_1 == 2) {
    _tmp38_1 = next_luma_x;
    next_luma_x = _tmp38_1 - 8;
    _tmp39_1 = next_luma_y;
    next_luma_y = _tmp39_1 + 8;
  }
  _tmp40_1 = next_comp;
  if (_tmp40_1 > 3) {
    next_comp = 0;
    ...
    _tmp42_1 = next_mbx;
    _tmp43_1 = vop_width;
    if (_tmp42_1 >= _tmp43_1) {
      next_mbx = 0;
      next_luma_x = 0;
      _tmp44_1 = next_mby;
      next_mby = _tmp44_1 + 1;
      _tmp45_1 = next_luma_y;
      next_luma_y = _tmp45_1 + 8;
    } else {
      _tmp46_1 = next_luma_x;
      next_luma_x = _tmp46_1 + 8;
      _tmp47_1 = next_luma_y;
      next_luma_y = _tmp47_1 - 8;
    }
  }
}
...
static void cmd_newVop() {
  ...
  BTYPE = getReadPtr(address_02_BTYPE, 1);
  cmd_1 = BTYPE[0];
  round = (cmd_1 & 32) != 0;
}
...
static int isSchedulable_cmd_newVop() {
  ...
  _tmp1_1 = hasTokens(address_02_BTYPE, 1);
  if (_tmp1_1) {
    BTYPE = getPeekPtr(address_02_BTYPE, 1);
    cmd_1 = BTYPE[0];
...
static int isSchedulable_getmvx() {
  ...
  _tmp1_1 = hasTokens(address_02_MV, 1);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void getmvy() {
  ...
  halfpel = getWritePtr(address_02_halfpel, 1);
  MV = getReadPtr(address_02_MV, 1);
  y_1 = MV[0];
  interp_y0_1 = (y_1 & 1) == 1;
  mvy = y_1 >> 1;
...
static void write_addr() {
  ...
  WA = getWritePtr(address_02_WA, 1);
  _tmp0_1 = write_count;
  _tmp1_1 = write_count;
...
static void read_addr() {
  ...
  RA = getWritePtr(address_02_RA, 1);
  _tmp0_1 = mvx;
  _tmp1_1 = read_col;
  _tmp2_1 = mvy;
  _tmp3_1 = read_row;
    ...
    if (isSchedulable_cmd_noMotion()) {
      ...
      if (isSchedulable_cmd_motion()) {
        ...
        if (isSchedulable_cmd_neither()) {
          if (hasRoom(address_02_halfpel, 1)) {
            cmd_neither();
            _FSM_state = s_init;
            res = 1;
          } else {
