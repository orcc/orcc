...
extern struct fifo_s *IAP_02_PQF_AC;
extern struct fifo_s *IAP_02_PTR;
extern struct fifo_s *IAP_02_AC_PRED_DIR;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *IAP_02_QF_AC;
...
static void newvop() {
  ...
  AC_PRED_DIR = getReadPtr(IAP_02_AC_PRED_DIR, 1);
  comp = 0;
  ptr = 4;
}
...
static int isSchedulable_newvop() {
  ...
  _tmp1_1 = hasTokens(IAP_02_AC_PRED_DIR, 1);
  if (_tmp1_1) {
    AC_PRED_DIR = getPeekPtr(IAP_02_AC_PRED_DIR, 1);
    s_1 = AC_PRED_DIR[0];
    _tmp0_1 = s_1 == -2;
    _tmp0_2 = _tmp0_1;
  } else {
...
static int isSchedulable_start() {
  ...
  _tmp1_1 = hasTokens(IAP_02_AC_PRED_DIR, 1);
  _tmp2_1 = hasTokens(IAP_02_PTR, 1);
  if (_tmp1_1 && _tmp2_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void copy() {
  ...
  QF_AC = getWritePtr(IAP_02_QF_AC, 1);
  PQF_AC = getReadPtr(IAP_02_PQF_AC, 1);
  ac_1 = PQF_AC[0];
  pred0_1 = ac_1;
  _tmp0_1 = count;
  v0_1 = _tmp0_1 & 7;
...
static int isSchedulable_copy() {
  ...
  _tmp1_1 = hasTokens(IAP_02_PQF_AC, 1);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
