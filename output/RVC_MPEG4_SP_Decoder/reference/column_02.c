...
extern struct fifo_s *column_02_X;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *column_02_Y;
...
static void untagged01() {
  ...
  Y = getWritePtr(column_02_Y, 8);
  X = getReadPtr(column_02_X, 8);
  _i0_1 = 0;
  _i0_3 = _i0_1;
  while (_i0_3 < 8) {
    _tmp0_1 = X[1 * _i0_3 + 0];
...
static int isSchedulable_untagged01() {
  ...
  _tmp1_1 = hasTokens(column_02_X, 8);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
...
int column_02_scheduler() {
  int res = 1;
  
  while (res) {
    if (isSchedulable_untagged01()) {
      if (hasRoom(column_02_Y, 8)) {
        untagged01();
        res = 1;
      } else {
        res = 0;
