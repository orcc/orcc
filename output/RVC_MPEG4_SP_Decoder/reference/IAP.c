...
extern struct fifo_s *IAP_PQF_AC;
extern struct fifo_s *IAP_PTR;
extern struct fifo_s *IAP_AC_PRED_DIR;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *IAP_QF_AC;
...
static void newvop() {
  ...
  AC_PRED_DIR = getReadPtr(IAP_AC_PRED_DIR, 1);
  ptr = 1;
}
...
static int isSchedulable_newvop() {
  ...
  _tmp1_1 = hasTokens(IAP_AC_PRED_DIR, 1);
  if (_tmp1_1) {
    AC_PRED_DIR = getPeekPtr(IAP_AC_PRED_DIR, 1);
    s_1 = AC_PRED_DIR[0];
    _tmp0_1 = s_1 == -2;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void copy() {
  ...
  QF_AC = getWritePtr(IAP_QF_AC, 1);
  PQF_AC = getReadPtr(IAP_PQF_AC, 1);
  ac_1 = PQF_AC[0];
  pred0_1 = ac_1;
  _tmp0_1 = count;
  v0_1 = _tmp0_1 & 7;
...
static int isSchedulable_copy() {
  ...
  _tmp1_1 = hasTokens(IAP_PQF_AC, 1);
  if (_tmp1_1) {
    _tmp0_1 = 1;
    _tmp0_2 = _tmp0_1;
  } else {
