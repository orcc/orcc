...
extern struct fifo_s *IS_02_AC_PRED_DIR;
extern struct fifo_s *IS_02_QFS_AC;

////////////////////////////////////////////////////////////////////////////////
// Output FIFOs

extern struct fifo_s *IS_02_PQF_AC;
...
static void skip() {
  ...
  AC_PRED_DIR = getReadPtr(IS_02_AC_PRED_DIR, 1);
}
...
static int isSchedulable_skip() {
  ...
  _tmp1_1 = hasTokens(IS_02_AC_PRED_DIR, 1);
  if (_tmp1_1) {
    AC_PRED_DIR = getPeekPtr(IS_02_AC_PRED_DIR, 1);
    i_1 = AC_PRED_DIR[0];
    _tmp0_1 = i_1 < 0;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void read_only() {
  ...
  QFS_AC = getReadPtr(IS_02_QFS_AC, 1);
  ac_1 = QFS_AC[0];
  _tmp0_1 = wa();
  buf[_tmp0_1] = ac_1;
  count++;
...
static int isSchedulable_read_only() {
  ...
  _tmp1_1 = hasTokens(IS_02_QFS_AC, 1);
  if (_tmp1_1) {
    QFS_AC = getPeekPtr(IS_02_QFS_AC, 1);
    _tmp2_1 = count;
    _tmp0_1 = _tmp2_1 < 64;
    _tmp0_2 = _tmp0_1;
  } else {
...
static void write_only() {
  ...
  PQF_AC = getWritePtr(IS_02_PQF_AC, 1);
  addr++;
  count++;
  _tmp2_1 = addr;
