...
Notable changes and features
----------------------------
- Embedded runtime libraries (C, Java and TTA) automatically extracted during the
code generation.
...
- Removed dependencies to JGraphT (FSM builder, Merger, etc) in favor of DFtools
graph API.
